 ...
 * All the methods are static so that we can call them directly by using class name.
 * All the methods are public so that we can access them in any other class.
 *
 */
public class Utility {
    ...
    /**
     * The Driver.get() method returns the WebDriver instance, which is then assigned to the driver variable in the Utility class.
     * This driver variable is used throughout the Utility class to interact with the browser and perform various actions.
     */
...
//*************************** Action Methods ***************************************//
    ...
    public static WebElement waitForElementWithFluentWait(By by, int time, int pollingTime) {
        ...
        return wait.until((Function<WebDriver, WebElement>) driver1 -> driver1.findElement(by));
    }
